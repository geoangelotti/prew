...
import com.example.prew.dto.Child
import com.example.prew.dto.CycleChild
...
class Repository(private val dsl: DSLContext) {
    ...
    private fun buildTree(id: Int, maxDepth: Int = 10): Node<Int> {
    ...
    private fun getChild(
        ...
        val children = edges.map { edge ->
            getChild(edge.to, maxDepth - 1, visited)
        }
        return NodeChild(Node(id, children))
    }
